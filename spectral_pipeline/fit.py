...
def fit_pair(ds_lf: DataSet, ds_hf: DataSet,
    ...
    return FittingResult(
        ...
        C_lf=C_lf,
        C_hf=C_hf,
        noise_mult_lf=noise_mult_lf,
        noise_add_lf=noise_add_lf,
        noise_mult_hf=noise_mult_hf,
        noise_add_hf=noise_add_hf,
        f1_err=sigma_f1,
        f2_err=sigma_f2,
        cost=cost,
    ), cost
    ...
    *,
    ...
    if best_fit.f1 > best_fit.f2:
        ...
        best_fit = FittingResult(
            ...
            C_lf=best_fit.C_lf,
            C_hf=best_fit.C_hf,
            noise_mult_lf=best_fit.noise_mult_lf,
            noise_add_lf=best_fit.noise_add_lf,
            noise_mult_hf=best_fit.noise_mult_hf,
            noise_add_hf=best_fit.noise_add_hf,
...
def fit_single(ds: DataSet,
    ...
    (k_fin, C_fin, A1_fin, A2_fin, tau1_fin, tau2_fin,
     f1_fin, f2_fin, phi1_fin, phi2_fin,
     noise_mult_fin, noise_add_fin) = p
    logger.debug(
    ...
    return (
        ...
        C_lf=C_fin,
        C_hf=float("nan"),
        noise_mult_lf=noise_mult_fin,
        noise_add_lf=noise_add_fin,
        f1_err=sigma_f1,
        f2_err=sigma_f2,
        cost=cost,
    ),
